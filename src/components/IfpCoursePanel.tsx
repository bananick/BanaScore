...
import { COURSE_MAX, coursePoints, coursePositionFromPoints, groupOfTeam } from '../ifp';

const fmt = (n: number) => n.toLocaleString('fr-FR');

/** Groupe d'une équipe : champ team_group si présent, sinon déduit du nom. */
const groupOf = (t: TeamDTO): string => t.team_group || groupOfTeam(t.name) || '';
        ...
        return (
          ...
          >
            <span style={{ fontWeight: 600 }}>
              {g && <span style={{ opacity: 0.5, marginRight: 6, fontSize: '0.8rem' }}>{g}</span>}
              {team.name}
            </span>
